...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'aarch64-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/usr/shared/CMPT/courses/cmpt295/miniconda3/lib '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/usr/shared/CMPT/courses/cmpt295/miniconda3/lib '
                      '-L/usr/shared/CMPT/courses/cmpt295/miniconda3/lib',
 'CONFIG_ARGS': "'--prefix=/usr/shared/CMPT/courses/cmpt295/miniconda3' "
                ...
                "-I/usr/shared/CMPT/courses/cmpt295/miniconda3/include' "
                "'CPP=/usr/shared/CMPT/courses/cmpt295/miniconda3/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/usr/shared/CMPT/courses/cmpt295/miniconda3/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/shared/CMPT/courses/cmpt295/miniconda3/lib/pkgconfig',
 'LIBPL':
     '/usr/shared/CMPT/courses/cmpt295/miniconda3/lib/python3.8/config-3.8-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/usr/shared/CMPT/courses/cmpt295/miniconda3/include',
 'OPENSSL_LDFLAGS': '-L/usr/shared/CMPT/courses/cmpt295/miniconda3/lib',
